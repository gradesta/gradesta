...
from gradesta_level0.level0 import *
from gradestalib.paths import match_path
from gradestalib.cell_reference_db import CellReferenceDB
import gradestalib.simple_topology_expressions
from gradestalib.gradesta_locales import Localizer
from gradestalib.level0_yaml import to_capnp
...
class Page:
    ...
    def connections(self) -> Iterator[Tuple["Cell", "Cell", int]]:
        ...
        connections = gradestalib.simple_topology_expressions.get_connections(
