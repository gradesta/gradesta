...
async fn test_create_rollback_on_upload_fail() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::CreateVertex {
            ...
            file_path: ".gradesta-notes/content/fail.txt".to_string(),
...
async fn test_create_rollback_restores_source_edges() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::CreateVertex {
            ...
            file_path: ".gradesta-notes/content/new.txt".to_string(),
            mime: "text/plain".to_string(),
...
async fn test_create_rollback_restores_displaced_edges() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::CreateVertex {
            ...
            file_path: ".gradesta-notes/content/x.txt".to_string(),
            mime: "text/plain".to_string(),
            from_vertex: hash_a,
            direction: Direction::East,
...
async fn test_delete_rollback_restores_content() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::DeleteVertex {
            uuid,
            files_to_delete: vec![".gradesta-notes/content/restore.txt".to_string()],
            original_content: original_content.to_vec(),
            original_mime: "text/plain".to_string(),
            original_file: ".gradesta-notes/content/restore.txt".to_string(),
            original_edges,
...
async fn test_delete_rollback_restores_neighbor_edges() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::DeleteVertex {
            uuid: uuid_x,
            files_to_delete: vec![".gradesta-notes/content/x.txt".to_string()],
            original_content: b"X content".to_vec(),
            original_mime: "text/plain".to_string(),
            original_file: ".gradesta-notes/content/x.txt".to_string(),
...
async fn test_edit_rollback_restores_content() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::EditVertex {
            ...
            file_path: ".gradesta-notes/content/edit.txt".to_string(),
            mime: "text/plain".to_string(),
            layer: 0,
            original_content: original_content.to_vec(),
            original_mime: "text/plain".to_string(),
