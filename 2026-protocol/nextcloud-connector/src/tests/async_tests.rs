...
async fn test_create_queued_for_async() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::CreateVertex {
            ...
            file_path: ".gradesta-notes/content/test.txt".to_string(),
...
async fn test_delete_queued_for_async() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::DeleteVertex {
            uuid,
            files_to_delete: vec![".gradesta-notes/content/delete-me.txt".to_string()],
            original_content: b"Delete me".to_vec(),
            original_mime: "text/plain".to_string(),
            original_file: ".gradesta-notes/content/delete-me.txt".to_string(),
            original_edges: [0; 6],
...
async fn test_edit_queued_for_async() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::EditVertex {
            ...
            file_path: ".gradesta-notes/content/edit-me.txt".to_string(),
            mime: "text/plain".to_string(),
            layer: 0,
...
async fn test_sync_worker_processes_create() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::CreateVertex {
            ...
            file_path: ".gradesta-notes/content/git-test.txt".to_string(),
            mime: "text/plain".to_string(),
            from_vertex: 0,
            direction: Direction::East,
            original_source_edges: None,
...
async fn test_sync_worker_processes_delete() {
    ...
    let work_item = SyncWorkItem {
        ...
        operation: SyncOperation::DeleteVertex {
            uuid,
            files_to_delete: vec![".gradesta-notes/content/to-delete.txt".to_string()],
            original_content: b"Delete me".to_vec(),
            original_mime: "text/plain".to_string(),
            original_file: ".gradesta-notes/content/to-delete.txt".to_string(),
            original_edges: [0; 6],
            affected_neighbors: vec![],
        },
    };
    ...
    for i in 0..3 {
        ...
        let work_item = SyncWorkItem {
            ...
            operation: SyncOperation::CreateVertex {
                ...
                file_path: format!(".gradesta-notes/content/batch-{}.txt", i),
                mime: "text/plain".to_string(),
                from_vertex: 0,
                direction: Direction::East,
                original_source_edges: None,
