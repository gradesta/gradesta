...
2. Advertising: We won't sell our user's time without their consent. We will not use automated systems such as telerobots and unsolicited emails. We will not use video/animated or audio advertisements or any other type of advertisement that is specifically intended to grab the user's attention despite the user's concerted effort to focus on something else. Nor will we use or allow on our commercial platforms advertisements that cover content or require the users to click away. As a company policy, we will actively discourage content which is primarily funded by advertising.
