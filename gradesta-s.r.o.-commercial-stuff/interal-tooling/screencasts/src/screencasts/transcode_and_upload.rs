...
///
pub fn transcode_and_upload<'a>(blogpost: &'a str, video_files: Vec<&str>) -> Result<Dag<RefCell<Command>, ()>, Box<dyn Error + 'a>>
{
...
mod tests {
    ...
    fn test_generate_commands() {
        let commands = transcode_and_upload("My blog post {{<screencast \"video-id\">}} {{<screencast \"video-id-2\">}}", vec!["/home/user/Videos/screencast1.mkv", "/home/user/Videos/screencast2.mkv"]).unwrap();
